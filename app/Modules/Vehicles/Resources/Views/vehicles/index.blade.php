...
<td><img src="{{asset('/')}}/storage/app/{{$image->url }}" class="img" ></td>
@elseif(!empty($image2))
<td><img src="{{asset('/')}}/storage/app/{{$image2->url }}" class="img" ></td>

@else
<td><img src="{{asset('/')}}/storage/app/public/vehicles/car.jpg" class="img" ></td>
@endif
