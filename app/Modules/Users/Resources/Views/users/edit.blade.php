...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
          <p>
          <span class="badge badge-warning ">   Updated {{ $diffs = Carbon\Carbon::parse($user->updated_at)->diffForHumans() }} </span>   &nbsp
          <span class="badge badge-success ">   Created {{ $diffs = Carbon\Carbon::parse($user->created_at)->diffForHumans() }} </span>    &nbsp
          </p>
          @if ($errors->any())
        ...
        <div class="card">
            ...
            <h5 class="card-title">Edit {{$user->name}}  User</h5>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            <div class="row">
              ...
              <div class="box-body">
                  <div class="row">
                    <div class="form-group col-md-6  ">
                        ...
                        <input type="text"  name="name" value="{{$user->name}}" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="exampleInputEmail1" placeholder="Enter Name"  >
                        @if ($errors->has('name'))
                    ...
                    <div class=" col-md-3 form-group">
                        ...
                        <label class="radio-inline">
                          <input type="radio" id="Active" name="user_status" value="1" @php echo $user->user_status == 1 ? 'checked' :  "" @endphp> Active</label>
                        </label>
                       <label class="radio-inline">
                          <input type="radio" id="Deactive" name="user_status" value="0"@php echo $user->user_status == 0 ? 'checked' :  "" @endphp > Deactive</label>
                       </label>
                    </div>
                  </div>
              </div>
