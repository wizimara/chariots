                        ...
                        @foreach ($permissions as $permission)
                            <tr>
                                ...
                                <td><a title="Edit" href="#" data-id="{{$permission->id}}" data-name="{{$permission->name}}" data-toggle="modal"  data-target="#editModal"><i class="fas fa-edit"></i></a>
                                    <a title="Delete" onclick="return confirm('Are you sure you want to delete this Permission')" href="{{route('users.permissions.delete',$permission->id)}}"><span style="color:tomato"><i class="fas fa-trash-alt"></i></span></a>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="col-md-12">
              <form role="form" action="{{route('users.permissions.store')}}" method="POST" enctype="multipart/form-data" >
              {{csrf_field() }}
      ...
      <!-- /.modal -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="col-md-12">
              <form role="form" action="{{route('users.permissions.update','hhh')}}" method="POST" enctype="multipart/form-data" >
              {{csrf_field() }}
