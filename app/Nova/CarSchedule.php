...
class CarSchedule extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Modules\Renting\Models\CarSchedule::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            BelongsTo::make('Vihicle','pricing', \App\Nova\Pricing::class),
